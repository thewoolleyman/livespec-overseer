...
class RequiresContextResult(  # type: ignore[type-var]
    BaseContainer,
    SupportsKind3["RequiresContextResult", _ValueType_co, _ErrorType_co, _EnvType_contra],
    ...
    def __call__(self, deps: _EnvType_contra) -> Result[_ValueType_co, _ErrorType_co]:
        """
