...
class RequiresContextFutureResult(  # type: ignore[type-var]
    ...
    future_result.FutureResultLike3[_ValueType_co, _ErrorType_co, _EnvType_contra],
):
    """
    ...
    _inner_value: Callable[[_EnvType_contra], FutureResult[_ValueType_co, _ErrorType_co]]
    ...
    def __init__(
        self,
        inner_value: Callable[[_EnvType_contra], FutureResult[_ValueType_co, _ErrorType_co]],
    ) -> None:
        """
    ...
    def __call__(self, deps: _EnvType_contra) -> FutureResult[_ValueType_co, _ErrorType_co]:
        """
    ...
    def swap(
        self,
    ) -> RequiresContextFutureResult[_ErrorType_co, _ValueType_co, _EnvType_contra]:
        """
    ...
    ) -> RequiresContextFutureResult[_NewValueType, _ErrorType_co, _EnvType_contra]:
        """
    ...
    def bind_context_ioresult(
        ...
        function: Callable[
            [_ValueType_co],
            RequiresContextIOResult[_NewValueType, _ErrorType_co, _EnvType_contra],
        ],
    ) -> RequiresContextFutureResult[_NewValueType, _ErrorType_co, _EnvType_contra]:
        """
    ...
    ) -> RequiresContextFutureResult[_ValueType_co, _NewErrorType, _EnvType_contra]:
        """
    ...
    def ask(
        cls,
    ) -> RequiresContextFutureResult[_EnvType_contra, _ErrorType_co, _EnvType_contra]:
        """
    ...
    def from_future_result_context(
        cls,
        inner_value: ReaderFutureResult[_NewValueType, _NewErrorType, _NewEnvType],
    ...
    ) -> RequiresContextFutureResult[_NewValueType, _NewErrorType, _EnvType_contra]:
        """
