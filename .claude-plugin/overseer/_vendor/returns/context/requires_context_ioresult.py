...
class RequiresContextIOResult(  # type: ignore[type-var]
    BaseContainer,
    SupportsKind3["RequiresContextIOResult", _ValueType_co, _ErrorType, _EnvType_contra],
    reader_ioresult.ReaderIOResultBasedN[_ValueType_co, _ErrorType, _EnvType_contra],
):
    """
    ...
    _inner_value: Callable[[_EnvType_contra], IOResult[_ValueType_co, _ErrorType]]
    ...
    def __init__(
        self,
        inner_value: Callable[[_EnvType_contra], IOResult[_ValueType_co, _ErrorType]],
    ) -> None:
        """
    ...
    def __call__(self, deps: _EnvType_contra) -> IOResult[_ValueType_co, _ErrorType]:
        """
    ...
    def bind_ioresult(
        self,
        function: Callable[[_ValueType_co], IOResult[_NewValueType, _ErrorType]],
    ) -> RequiresContextIOResult[_NewValueType, _ErrorType, _EnvType_contra]:
        """
